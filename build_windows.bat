...
where py >nul 2>nul
if errorlevel 1 (
    echo Python Launcher bulunamadi. Python 3.14 x64 kurun.
    pause
    exit /b 1
)
...
echo.
echo NexaEdit hazir: dist\NexaEdit\NexaEdit.exe
pause
exit /b 0

:fail
echo.
echo Derleme basarisiz. Python 3.14 x64 ve Tcl/Tk kurulu olmali.
pause
exit /b 1
